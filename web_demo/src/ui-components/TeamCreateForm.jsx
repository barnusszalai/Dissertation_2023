...
export default function TeamCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setHeadquarter(initialValues.headquarter);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.headquarter ?? value;
          }
          if (errors.headquarter?.hasError) {
            runValidationTasks("headquarter", value);
          }
          setHeadquarter(value);
        }}
        onBlur={() => runValidationTasks("headquarter", headquarter)}
        errorMessage={errors.headquarter?.errorMessage}
        hasError={errors.headquarter?.hasError}
        {...getOverrideProps(overrides, "headquarter")}
      ></TextField>
      <Flex
